function [VarName1,VarName2,IntdosEEFermi1514eV] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [VARNAME1,VARNAME2,INTDOSEEFERMI1514EV] = IMPORTFILE(FILENAME) Reads
%   data from text file FILENAME for the default selection.
%
%   [VARNAME1,VARNAME2,INTDOSEEFERMI1514EV] = IMPORTFILE(FILENAME,
%   STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of text
%   file FILENAME.
%
% Example:
%   [VarName1,VarName2,IntdosEEFermi1514eV] = importfile('espresso.dos',2, 10002);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2022/06/15 12:03:41
...
IntdosEEFermi1514eV = dataArray{:, 3};
