...
filename = 'D:\Tugas\Tugas Akhir\Struktur\Graphene 5x5\GrapheneOH\GrapheneOH1\espresso.pdos_tot';
startRow = 2;
formatSpec = '%8f%12f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'EmptyValue' ,NaN,'HeaderLines' ,startRow-1, 'ReturnOnError', false);
...
filename = 'D:\Tugas\Tugas Akhir\Struktur\Graphene 5x5\GrapheneOH2\GrapheneOH2\espresso.pdos_tot';
startRow = 2;
formatSpec = '%8f%12f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'EmptyValue' ,NaN,'HeaderLines' ,startRow-1, 'ReturnOnError', false);
...
filename = 'D:\Tugas\Tugas Akhir\Struktur\Graphene 5x5\GrapheneOH3\GrapheneOH3\espresso.pdos_tot';
startRow = 2;
formatSpec = '%8f%12f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'EmptyValue' ,NaN,'HeaderLines' ,startRow-1, 'ReturnOnError', false);
...
filename = 'D:\Tugas\Tugas Akhir\Struktur\Graphene 5x5\GrapheneOH4\GrapheneOH4\espresso.pdos_tot';
startRow = 2;
formatSpec = '%8f%12f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'EmptyValue' ,NaN,'HeaderLines' ,startRow-1, 'ReturnOnError', false);
...
filename = 'D:\Tugas\Tugas Akhir\Struktur\Graphene 5x5\GrapheneOH5\GrapheneOH5\espresso.pdos_tot';
startRow = 2;
formatSpec = '%8f%12f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'EmptyValue' ,NaN,'HeaderLines' ,startRow-1, 'ReturnOnError', false);
